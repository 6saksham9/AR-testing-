...
class MultipleAugmentedImagesPage extends StatefulWidget {
  ...
  @override
  State<MultipleAugmentedImagesPage> createState() =>
...
class _MultipleAugmentedImagesPageState
  ...
  // void _onImageNodeTap(ArCoreAugmentedImage augmentedImage) {
  //   final node = ArCoreReferenceNode(
  //       name: 'soldier',
  //       // objectUrl:
  //       //     'https://mhappstorage.blob.core.windows.net/monkhubhr/section/soldier1/soldier.glb',
  //       object3DFileName: 'assets/car.glb',
  ...
  //   final ByteData textureBytes = await rootBundle.load('assets/car.glb');
